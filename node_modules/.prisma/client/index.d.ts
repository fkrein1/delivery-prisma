  ...
  */
  ...
  export type DeliveriesGetPayload<
    ...
    [P in TrueKeys<S['include']>]:
        ...
        P extends 'deliveryman' ? DeliveryManGetPayload<Exclude<S['include'], undefined | null>[P]> | null :  never
  } 
    : 'select' extends U
    ? {
    [P in TrueKeys<S['select']>]:
        P extends 'client' ? ClientsGetPayload<Exclude<S['select'], undefined | null>[P]> :
        P extends 'deliveryman' ? DeliveryManGetPayload<Exclude<S['select'], undefined | null>[P]> | null :  P extends keyof Deliveries ? Deliveries[P] : never
  } 
    : Deliveries
  : Deliveries
